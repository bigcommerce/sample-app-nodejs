                ...
                <div style={{fontSize: "1.5rem"}} className="PackingSlipDetails">
                    <div className="PackingSlipDetailsLeft">
                        ...
                        <div style={{display: "flex"}}>
                            <div style={{fontWeight: 'bold'}}>%%LNG_ShipmentOrderDate%%:</div>
                            <div style={{marginLeft: "5%"}}>%%GLOBAL_OrderDate%%</div>
                        </div>
                    </div>
                    <div className="PackingSlipDetailsRight">
                        <div style={{display: "flex"}}>
                            <div style={{fontWeight: 'bold'}}>%%LNG_ShippingMethod%%:</div>
                            <div style={{marginLeft: "5%"}}>%%GLOBAL_ShippingMethod%%</div>
                        </div>
                    </div>
                </div><br/><br/>
